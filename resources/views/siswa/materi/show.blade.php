                                                    ...
                                                    <div class="media lihat-file" data-toggle="modal" data-target="#fileModal" data-source="{{ $file->nama }}" data-extension="{{ $ekstensi }}" style="cursor: pointer; margin-top: 5px; margin-bottom: 5px;">
                                                        <div class="mr-1">
                                                            @if ($ekstensi == 'mp4' || $ekstensi == 'mkv' || $ekstensi == 'ogg')
                                                                <img alt="avatar" width='40px' src="{{ url("/_assets/img/docs/mp4.svg") }}" class="img-fluid">
    
                                                                @elseif ($ekstensi == 'mp3' || $ekstensi == 'mpeg' || $ekstensi == 'm4a')
                                                                    <img alt="avatar" width='40px' src="{{ url("/_assets/img/docs/mp3.svg") }}" class="img-fluid">
    
                                                                @elseif ($ekstensi == 'jpg' || $ekstensi == 'png' || $ekstensi == 'jpeg' || $ekstensi == 'svg' || $ekstensi == 'gif')
                                                                    <img alt="avatar" width='40px' src="{{ asset('_assets/files/' . $file->nama) }}" class="img-fluid">
    
                                                                @elseif ($ekstensi == 'xls' || $ekstensi == 'xlsx' || $ekstensi == 'csv')
                                                                    <img alt="avatar" width='40px' src="{{ url("/_assets/img/docs/xls.svg") }}" class="img-fluid">
    
                                                                @elseif ($ekstensi == 'doc' || $ekstensi == 'docx')
                                                                    <img alt="avatar" width='40px' src="{{ url("/_assets/img/docs/doc.svg") }}" class="img-fluid">
    
                                                                @elseif ($ekstensi == 'pdf')
                                                                    <img alt="avatar" width='40px' src="{{ url("/_assets/img/docs/pdf.svg") }}" class="img-fluid">
    
                                                                @elseif ($ekstensi == 'ppt' || $ekstensi == 'pptx')
                                                                    <img alt="avatar" width='40px' src="{{ url("/_assets/img/docs/ppt.svg") }}" class="img-fluid">
                                                                @else
                                                                    <img alt="avatar" width='40px' src="{{ url("/_assets/img/docs/file.png") }}" class="img-fluid">
                                                            @endif
        ...
        if (extension == 'mp4' || extension == 'mkv' || extension == 'ogg') {
            var html = `
                ...
                <video controls preload="metadata" style="width: 100%">
                    <source src="{{ asset('_assets/files') }}/`+ source +`" type="video/`+ extension +`"/>
            ...
            var html = `
                ...
                <audio controls>
                    <source src="{{ asset('_assets/files') }}/`+ source +`" type="audio/`+ extension +`"/>
            ...
            var html = `
                <img alt="file" src="{{ asset('_assets/files') }}/`+ source +`" class="img-fluid">
            `;
            ...
            var html = `
                <object data="{{ asset('_assets/files') }}/`+ source +`" type="application/pdf" width="100%" height="500px">
                    <p>
