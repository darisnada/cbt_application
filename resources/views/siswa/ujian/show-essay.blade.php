                                            ...
                                            <div>
                                                ...
                                                @foreach ($essay_siswa as $soal)
                                                    <div class="question {{ $soal_hidden }} question-{{ $no }}" data-question="{{ $no }}">
                                                        <div class="-heading pl-2 pt-2" style="border-bottom: 1px solid #e0e6ed;">
                                                            <div class="">
                                                        ...
                                                        <div class=" p-3 mt-3">
                                                            <div class="-heading" style="border-bottom: 1px solid #e0e6ed;">
                                                                <h6 class="question-title color-green" style="word-wrap: break-word">
                                                                    {!! $soal->detailessay->soal !!}
                                                                </h6>
                                                            </div>
                                                            <div class="-content mt-3" style="position: relative;">
                                                    ...
                                                    @foreach ($essay_siswa as $soal)
                                                        <div class="question {{ $soal_hidden }} question-{{ $no }}" data-question="{{ $no }}">
                                                            ...
                                                            <div class=" p-3 mt-3">
                                                                ...
                                                                <div class="-footer pt-2" style="border-top: 1px solid #e0e6ed; font-weight: bold;">
