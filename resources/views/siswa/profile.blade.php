                                ...
                                <div class="user-profile layout-spacing">
                                    <div class="">
                                        ...
                                        <div class="text-center user-info">
                                            <img src="{{ asset('_assets/user-profile/' . $siswa->avatar) }}" class="img-user" alt="avatar" style="width: 125px; height: 125px;">
                                        ...
                                        <form action="{{ url("/siswa/edit_profile/" . $siswa->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input form-control" name="avatar" id="customFile" accept=".jpg, .png, .jpeg" onchange="previewImg()">
