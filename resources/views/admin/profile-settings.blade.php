                            ...
                            <div class="">
                                <div class="">
                                    ...
                                    <div class="text-center user-info">
                                        <img src="{{ asset('_assets/user-profile/' . $admin->avatar) }}" class="img-user" alt="avatar"style="width: 125px; height: 125px;">
                                    ...
                                    <form action="{{ url('/admin/smtp_email/' . (isset($email_settings->notif_akun) && $email_settings->notif_akun == '1') ? $email_settings->id : '') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="n-chk">
                                                ...
                                                <input type="radio" class="new-control-input" name="notif_akun" value="1" {{ (isset($email_settings->notif_akun) && $email_settings->notif_akun == '1') ? 'checked' : ''}}>
