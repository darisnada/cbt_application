...
@section('content')
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="tbody-kelas">
                                <tr>
                                    <td><input type="text" name="nama_kategori" required
                                            style="border: none; background: transparent; width: 100%; height: 100%;"></td>
                                    {{-- <td></td> --}}
                                </tr>
                            </tbody>
                        </table>
    ...
    <div class="modal fade" id="edit_kategori" tabindex="-1" role="dialog" aria-labelledby="edit_kelasLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="{{ url('/admin/kategori/edit-kategori') }}" method="POST">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="edit_kelasLabel">Edit Kategori</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            x
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="id" id="id_kategori" class="form-control">
           ...
           `;
            ...
            $("#datatable-table").DataTable({
                ...
                swal({
                    ...
                    text: "data yang berkaitan dengan data kategori ini juga akan di hapus!",
                    type: "warning",
                    showCancelButton: !0,
