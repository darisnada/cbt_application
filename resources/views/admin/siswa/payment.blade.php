                            ...
                            <table id="datatable-table" class="table text-center text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->is_proses == 1)
                                                <span class="badge bg-success text-light">Telah diterima</span>
                                            @else 
                                                <a href="{{url('/admin/siswa/payment/active/'.$item->id)}}" class="btn btn-sm btn-primary">Aktifkan</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
...
<script>
    function aktifkanSiswa(id){

        alert(id)
        $.ajax({
                type: 'GET',
                url: "{{url('/siswa/payment/active')}}/"+id,
                success: function () {
                    location.reload()
                }
        });
