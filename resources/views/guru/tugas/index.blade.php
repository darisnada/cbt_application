                                ...
                                <tbody>
                                    @foreach ($tugas as $t)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url("/guru/tugas/" . $t->kode) }}" class="btn btn-primary btn-sm"><span data-feather="eye"></span></a>
                                                <a href="{{ url("/guru/tugas/" . $t->kode . "/edit") }}" class="btn btn-success btn-sm"><span data-feather="edit"></span></a>
                                                <form action="{{ url("/guru/tugas/" . $t->kode) }}" method="post" class="d-inline" id="formHapus">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a class="btn btn-danger btn-sm btn-hapus" href="javascript:void(0);"><span data-feather="trash"></span></a>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
