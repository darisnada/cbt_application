                            ...
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-8 col-lg-5 col-xl-4">
                                    ...
                                    <div class="card card-body p-4">
                                        ...
                                        <form action="{{ url('/register') }}" method="POST" class=" z-1 position-relative needs-validation" novalidate="">
                                            @csrf
                                            <div class="form-floating mb-3">
                                                <input type="text" id="name" name="nama" class="form-control" value="{{old('nama')}}" required="" id="floatingInput"
                                                    placeholder="">
                                                <label for="floatingInput">Your Name</label>
                                                <span class="invalid-feedback">Please enter a your name</span>
                                                @error('nama')
                                            ...
                                            {{-- <div class=" mb-3">
                                                ...
                                                <input type="checkbox" id="saya_siswa" name="saya_siswa" value="1" class="custom-control-input" checked>
                                                    <label class="custom-control-label" for="saya_siswa">Saya Siswa</label>
                                                @else
                                                <input type="checkbox" id="saya_siswa" name="saya_siswa" value="1" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="saya_siswa">Saya Siswa</label>
                                                @endif
                                            ...
                                            <div class="form-floating mb-3">
                                            <input type="text" id="nis" value="{{old('nis')}}" name="nis" required="" class="form-control" id="floatingNIS" placeholder="NIS">
                                            <label for="nis">Nomor Induk Siswa</label>
                                            <span class="invalid-feedback">Enter the No Induk Siswa</span>
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <span class="invalid-feedback">Choose Kelas</span>
                                            </div>

                                            <button class="w-100 btn btn-lg btn-primary" type="submit">Sign Up</button>
                                            <hr class="mt-4 mb-3">
                                            <p class="text-muted text-center">
                                                You have account? <a href="{{url('/')}}"
                                                    class="ms-1">Login</a>
